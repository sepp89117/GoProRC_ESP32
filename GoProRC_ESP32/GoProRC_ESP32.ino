...
//--------------------- other declarations ----------------------------------------------------------------
const unsigned int rcUdpPort = 8383;            // UDP-Port der Fernbedienung
const unsigned int camUdpPort = 8484;           // UDP-Port der Kamera
...
void sendToCam(uint8_t* req, int noBytes) {
  ...
  //receiveFromSerialThread.disable();
  ...
  //receiveFromSerialThread.enable();
}
